...
abstract class BaseFragment<T : ViewDataBinding> : Fragment() {
    private val onBackPressedCallback = OnBackPressedCallback { onBackPressed(this) }
    ...
    open fun onBackPressed(onBackPressedCallback: OnBackPressedCallback) {
        onBackPressedCallback.callSuperOnBackPressed(requireActivity())
    }
}